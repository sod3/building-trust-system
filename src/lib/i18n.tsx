...
export const dict: Dict = {
  ...
  "common.no_records_body": {
    en: "Try adjusting your search or filter.",
    ar: "جرب تعديل بحثك أو فلترتك.",
  },
  ...
  "badge.kingdom": {
    en: "Built for Saudi Arabia & the Gulf",
    ar: "مصمّم للمملكة العربية السعودية والخليج",
  },
  ...
  "home.hero.title": {
    en: "Simple Daily Building Operations, Verified by Labour Checklists",
    ar: "عمليات تشغيل يومية للمباني ببساطة، مدعمة بقوائم تحقق العمال",
  },
  "home.hero.subtitle": {
    en: "Give building owners a clear dashboard to assign daily tasks, track labour work, and receive daily proof that cleaning, maintenance, elevator, water, lights, and security checks are completed.",
    ar: "امنح ملاك المباني لوحة تحكم واضحة لتعيين المهام اليومية وتتبع عمل العمال وتلقي إثبات يومي على اكتمال التنظيف والصيانة وفحص المصاعد والمياه والإضاءة والأمن.",
  },
  ...
  "sec.problem.title": {
    en: "Buildings run on WhatsApp groups, paper logs and excuses.",
    ar: "تُدار المباني عبر مجموعات الواتساب والسجلّات الورقية والأعذار.",
  },
  "sec.problem.body": {
    en: "Owners can't verify what was done. Supervisors chase labor. Tenants are ignored. Complaints get lost. Monthly reports are guesswork.",
    ar: "لا يستطيع الملّاك التحقق من إنجاز الأعمال، يطارد المشرفون العمّال، ويُهمَل المستأجرون، وتضيع الشكاوى، وتصبح التقارير الشهرية تخميناً.",
  },
  "sec.how.kicker": { en: "How it works", ar: "كيف تعمل" },
  "sec.how.title": {
    en: "From task to proof in four steps.",
    ar: "من المهمة إلى الإثبات في أربع خطوات.",
  },
  ...
  "sec.security.title": {
    en: "Enterprise security from day one.",
    ar: "أمان مؤسسي منذ اليوم الأول.",
  },
  "sec.pricing.kicker": { en: "Pricing", ar: "الأسعار" },
  "sec.pricing.title": {
    en: "Simple SAR pricing per portfolio.",
    ar: "تسعير بسيط بالريال لكل محفظة.",
  },
  "sec.pricing.body": {
    en: "Start at 499 SAR for one building. Scale to enterprise.",
    ar: "ابدأ بـ 499 ريال لمبنى واحد. وصولاً إلى الباقات المؤسسية.",
  },
  "sec.faq.kicker": { en: "FAQ", ar: "الأسئلة" },
  "sec.faq.title": { en: "Frequently Asked Questions", ar: "الأسئلة الشائعة" },
  "faq.pricing.q1": {
    en: "Can one owner manage multiple buildings?",
    ar: "هل يمكن لمالك واحد إدارة عدة مبانٍ؟",
  },
  "faq.pricing.a1": {
    en: "Yes, an owner account can be assigned multiple buildings depending on the plan.",
    ar: "نعم، يمكن تعيين عدة مبانٍ لحساب مالك واحد حسب الخطة.",
  },
  "faq.pricing.q2": {
  ...
  "sec.cta.title": {
    en: "Stop guessing. Start verifying.",
    ar: "توقّف عن التخمين. ابدأ بالتحقّق.",
  },
  "sec.cta.body": {
    en: "Run a 14-day pilot on one building. We'll set it up for you.",
    ar: "جرّب لمدة 14 يوماً على مبنى واحد. سنقوم بالإعداد لك.",
  },
  ...
  // Pricing Page
  "pricing.hero.title": {
    en: "Simple Pricing for Building Owners",
    ar: "أسعار بسيطة لملاك المباني",
  },
  "pricing.hero.subtitle": {
    en: "Choose the plan that fits your property portfolio. No hidden fees.",
    ar: "اختر الخطة المناسبة لمحفظة مبانيك. بدون رسوم مخفية.",
  },
  ...
  "pricing.desc.professional": {
    en: "Best for growing building portfolios",
    ar: "مناسبة للملاك الذين يديرون عدة مبانٍ",
  },
  "pricing.desc.enterprise": {
    en: "Best for large property groups",
    ar: "مناسبة للمجموعات العقارية الكبيرة",
  },
  ...
  "pricing.feat.multiple_users": {
    en: "Multiple owner/supervisor users later",
    ar: "مستخدمون متعددون لاحقاً",
  },
  ...
  "product.hero.title": {
    en: "One Simple Platform. Three Powerful Dashboards.",
    ar: "منصة بسيطة واحدة. ثلاث لوحات تحكم قوية.",
  },
  "product.hero.subtitle": {
    en: "From Super Admin to housemaster - each role gets exactly the screen they need.",
    ar: "من المسؤول الأعلى إلى العامل - كل دور يحصل تماماً على الشاشة التي يحتاجها.",
  },
  ...
  "product.built_for_proof": {
    en: "Built for daily proof of work",
    ar: "مصممة لإثبات إنجاز العمل اليومي",
  },
  "product.built_for_proof_desc": {
    en: "Building owners no longer need to call repeatedly or guess if work was completed. The platform is designed for one simple loop: Labour submits the daily checklist, and the owner instantly receives a verifiable daily report.",
    ar: "لم يعد ملاك المباني بحاجة إلى الاتصال المتكرر أو التخمين إذا كان العمل قد اكتمل. المنصة مصممة لحلقة واحدة بسيطة: العامل يرسل قائمة المهام اليومية، والمالك يتلقى فوراً تقريراً يومياً قابلاً للتحقق.",
  },
  ...
  "login.reset_msg": {
    en: "Password reset is not connected yet in demo mode. Please contact platform admin.",
    ar: "إعادة تعيين كلمة المرور غير متصلة حالياً في النسخة التجريبية. يرجى التواصل مع إدارة المنصة.",
  },
  "login.owner_notice": {
    en: "Owner dashboard is available after subscription",
    ar: "لوحة المالك متاحة بعد الاشتراك",
  },
  "login.labour_notice": {
    en: "Labour users receive credentials from their building owner",
    ar: "يتلقى العمال بيانات الدخول من مالك المبنى",
  },
  "login.admin_notice": {
    en: "Admin access is restricted to platform management only",
    ar: "وصول الإدارة مقتصر على إدارة المنصة فقط",
  },

  // Checkout Page
  "checkout.title": { en: "Checkout", ar: "إتمام الاشتراك" },
  "checkout.complete_access": {
    en: "Complete your owner access",
    ar: "أكمل بيانات الوصول إلى لوحة المالك",
  },
  ...
  "checkout.integration_soon": {
    en: "Payment integration coming soon",
    ar: "تكامل الدفع قادم قريباً",
  },
  "checkout.demo_notice": {
    en: "This is a frontend demo checkout",
    ar: "هذه صفحة دفع تجريبية للواجهة فقط",
  },
  "checkout.continue_demo": {
    en: "Continue to Owner Dashboard Demo",
    ar: "المتابعة إلى تجربة لوحة المالك",
  },
  "checkout.already_have": {
    en: "Already have access? Login",
    ar: "لديك وصول بالفعل؟ سجّل الدخول",
  },
  "checkout.success": { en: "Access created successfully", ar: "تم إنشاء الوصول بنجاح" },
  "checkout.redirecting": {
    en: "Redirecting to Owner Dashboard Demo",
    ar: "جاري التوجيه إلى تجربة لوحة المالك",
  },
  ...
  "dashboard.admin.desc": {
    en: "Manage owners, buildings, subscriptions, labour activity, and daily verification reports from one place",
    ar: "إدارة الملاك والمباني والاشتراكات ونشاط العمال وتقارير التحقق اليومية من مكان واحد",
  },
  ...
  "dashboard.owner.desc": {
    en: "Assign daily work, track labour activity, and receive proof that your building tasks are completed",
    ar: "عيّن الأعمال اليومية، تابع نشاط العمال، واستلم إثبات إنجاز مهام المبنى",
  },
  ...
  "owner.overview.no_reports": {
    en: "No reports submitted yet today.",
    ar: "لم يتم إرسال أي تقارير اليوم.",
  },
  ...
  "owner.overview.alert": {
    en: "One or more buildings need attention. Check building status for details.",
    ar: "مبنى واحد أو أكثر يحتاج إلى انتباه. تحقق من حالة المباني للتفاصيل.",
  },
  ...
  "dashboard.labour.submit_warning": {
    en: "Some tasks are still pending. Submit anyway?",
    ar: "بعض المهام ما زالت قيد الانتظار. هل تريد الإرسال على أي حال؟",
  },
  "dashboard.labour.success": { en: "Work submitted successfully", ar: "تم إرسال العمل بنجاح" },
  "dashboard.labour.report_sent": {
    en: "Report sent to Admin and Owner",
    ar: "تم إرسال التقرير إلى الإدارة والمالك",
  },
  "dashboard.labour.back_today": {
    en: "Back to Today's Checklist",
    ar: "العودة إلى قائمة مهام اليوم",
  },
  ...
  "labour.dashboard.submitted_desc_1": {
    en: "Today's work submitted successfully.",
    ar: "تم إرسال عمل اليوم بنجاح.",
  },
  "labour.dashboard.submitted_desc_2": {
    en: "Report sent to Admin and Owner.",
    ar: "أرسل التقرير إلى الإدارة والمالك.",
  },
  "labour.dashboard.summary": { en: "Today's Summary", ar: "ملخص اليوم" },
  "labour.dashboard.back_checklist": {
    en: "Back to Today's Checklist",
    ar: "العودة إلى قائمة مهام اليوم",
  },
  ...
  "labour.dashboard.instruction": {
    en: "Tick each task when completed, then submit your daily work.",
    ar: "ضع علامة على كل مهمة عند اكتمالها، ثم أرسل عملك اليومي.",
  },
  "labour.dashboard.progress": { en: "Progress", ar: "التقدم" },
  "labour.dashboard.all_completed": {
    en: "All tasks completed! Ready to submit.",
    ar: "تم إنجاز جميع المهام! جاهز للإرسال.",
  },
  "labour.dashboard.submit": { en: "Submit Today's Work", ar: "إرسال عمل اليوم" },
  "labour.dashboard.submit_progress": {
    en: "Submit Today's Work ({done}/{total} done)",
    ar: "إرسال عمل اليوم ({done}/{total} مكتمل)",
  },
  "labour.dashboard.pending_tasks": { en: "Pending Tasks", ar: "مهام معلقة" },
  "labour.dashboard.pending_desc": {
    en: "are still pending. Do you want to submit anyway?",
    ar: "ما زالت قيد الانتظار. هل تريد الإرسال على أي حال;",
  },
  ...
  "admin.owners.subtitle": {
    en: "Manage all building owner accounts and their subscriptions.",
    ar: "إدارة جميع حسابات ملاك المباني واشتراكاتهم.",
  },
  "admin.owners.add": { en: "Add Owner", ar: "إضافة مالك" },
  "admin.owners.edit": { en: "Edit Owner", ar: "تعديل بيانات المالك" },
  "admin.owners.search": {
    en: "Search owners by name or email…",
    ar: "ابحث عن ملاك بالاسم أو البريد…",
  },
  "admin.owners.reset_sent": {
    en: "Password reset email sent",
    ar: "تم إرسال بريد إعادة تعيين كلمة المرور",
  },
  "admin.buildings.title": { en: "Buildings", ar: "المباني" },
  "admin.buildings.subtitle": {
    en: "All buildings across the platform.",
    ar: "جميع المباني عبر المنصة.",
  },
  ...
  "admin.buildings.search": {
    en: "Search by building name, city, or owner…",
    ar: "ابحث باسم المبنى أو المدينة أو المالك…",
  },
  ...
  "owner.buildings.subtitle": {
    en: "All buildings assigned to your account.",
    ar: "جميع المباني المعيّنة لحسابك.",
  },
  ...
  "owner.assign.subtitle": {
    en: "Assign daily checklists to labour for each building.",
    ar: "تعيين قوائم مهام يومية للعمال لكل مبنى.",
  },
  ...
  "dashboard.labour.desc": {
    en: "Labour users get a very simple visual dashboard with large task cards, icons, check buttons, and one submit button. No complex menus or technical knowledge required.",
    ar: "يحصل العمال على لوحة تحكم بسيطة بصرياً ببطاقات مهام كبيرة وأيقونات وأزرار تحقق وزر إرسال واحد. لا توجد قوائم معقدة أو معرفة تقنية مطلوبة.",
  },
  ...
  "sol.sub": {
    en: "Whether you run three towers or three hundred - FacilityOS Arabia adapts.",
    ar: "سواء تدير ثلاثة أبراج أو ثلاثمئة - تتكيّف فاسيليتي أو إس مع احتياجك.",
  },
  "about.title": {
  ...
  "contact.sub": {
    en: "Tell us about your portfolio. We'll respond within one business day.",
    ar: "أخبرنا عن محفظتك. سنرد خلال يوم عمل واحد.",
  },
  ...
  "sec.page.sub": {
    en: "How we protect your buildings, your photos and your tenants.",
    ar: "كيف نحمي مبانيك وصورك ومستأجريك.",
  },
};
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const stored = (typeof window !== "undefined" &&
      localStorage.getItem("fos-lang")) as Lang | null;
