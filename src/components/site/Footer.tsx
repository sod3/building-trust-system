      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-4 lg:px-8">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/security" className="hover:text-foreground">Privacy</Link></li>
            <li><Link to="/security" className="hover:text-foreground">Terms</Link></li>
          </ul>
        </div>
      </div>
